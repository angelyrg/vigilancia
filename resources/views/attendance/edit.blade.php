    ...
    <div class="container col-md-4 col-md-offset-4" style="padding-top: .90em;">
        ...
        <div class="box box-primary ">
            <div class="box-header with-border">
                <h3 class="box-title">Registrar mi salida</h3>
            </div>
            <form method="POST" action="/attendance/{{$attendance->id}}">
                @csrf
                @method('put')
                ...
                <div class="box-body" style="margin-top: .50em;">
                    ...
                    <div class=" form-group {{ $errors->has('dni') ? ' has-error' : '' }}"  >
                        ...
                        <label for="dni">Ingrese su número de DNI para registrar su salida</label>
                        <div>
