        ...
        <div class="box box-primary ">
            ...
            <div class="row col container-fluid">
                ...
                <div class="container-fluid input-group">
                    ...
                    <input type="text" class="form-control" id="dni_search" name="dni_search" placeholder="Buscar docente por DNI" maxlength="8" autofocus>
                ...
                <form method="POST" action="/teachers">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group ">
                            ...
                            <div >
                                <textarea cols="30" rows="4" class="form-control{{ $errors->has('descripcion') ? ' is-invalid' : '' }}" name="descripcion" id="descripcion" required> {{ old('descripcion') }}</textarea>
